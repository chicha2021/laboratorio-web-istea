...
export const inputFilter = async () => {
  ...
  const handleSearch = () => {
    ...
    filterCards.forEach((p) => {
      ...
      card.innerHTML = `
                <div class="card" style="display:flex; align-items:center;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">${p.title.substring(0,40)} </p>
                        <p class="credit-price">Hasta 6 cuotas de $${(p.price / 6).toFixed(2)} </p>
                    </div>
      ...
      cartButtons[1].addEventListener('click', () => addToCart(p));
    });
  };
